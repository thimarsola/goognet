                ...
                <fieldset class="data__content__group">
                    ...
                    <div class="data__content__group__row">
                        ...
                        <div class="data__content__group__row__header">
                            <label for="area">Escolha no campo ao lado qual o segmento de atuação da sua empresa. <br><small>(Caso não encontre o seu segmento, solicite sua simulação pelo whatsapp)</small></label>
                        </div>
                        <!-- end of header -->
