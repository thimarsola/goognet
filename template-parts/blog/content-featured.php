<!-- card -->
<article class="featured__row__card">
    <!-- image -->
    <div class="featured__row__card__image">
    ...
    <!-- body -->
    <div class="featured__row__card__body bg-white-500">
        <!-- categories -->
        <?php
        the_category();
        ?>
        ...
        <!-- header -->
        <header class="featured__row__card__body__header">
            <h3><?= get_the_title(); ?></h3>
        ...
        <!-- content -->
        <div class="featured__row__card__body__content">
