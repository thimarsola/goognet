...
<!-- AUTHOR -->
<meta name="author" content="<?= SITE["name"]; ?> - <?= SITE["root"] ?>">
		...
		<div class="header__navbar">
			...
			<div class="container">
				...
				<a href="<?= get_home_url(); ?>"> <img
					alt="Logo Cozumel Estética e Bem-estar"
					src="<?= get_template_directory_uri(); ?>/assets/images/logo-header.svg"
					loading='lazy></a>
					...
					<div class="header__navbar__section">
                        ...
                        <a
								href="<?= get_permalink(get_page_by_title('Franquia')); ?>"
								class="btn btn--outline-theme-white" target="_blank">Seja um
								Franqueado</a>
						</nav>
					</div>
